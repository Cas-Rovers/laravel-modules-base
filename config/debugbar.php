<?php
    ...
    return [
        ...
        /*
         ...
         |
         | You can provide an array of URIs that must be ignored (e.g. 'api/*')
         |
         */
        ...
        */
        ...
        'options' => [
            'time' => [
                'memory_usage' => env('DEBUGBAR_OPTIONS_TIME_MEMORY_USAGE', true),
            ...
            'memory' => [
                'reset_peak' => env('DEBUGBAR_OPTIONS_MEMORY_RESET_PEAK', true),
                                                                                        // run memory_reset_peak_usage before collecting
                'with_baseline' => env('DEBUGBAR_OPTIONS_MEMORY_WITH_BASELINE', true),
            ...
            'gate' => [
                'trace' => true,      // Trace the origin of the Gate checks
            ],
            'db' => [
                ...
                'memory_usage' => env('DEBUGBAR_OPTIONS_DB_MEMORY_USAGE', true),   // Show queries memory usage
            ...
            'views' => [
                ...
                'data' => env('DEBUGBAR_OPTIONS_VIEWS_DATA', true),
            ...
            'events' => [
                'data' => env('DEBUGBAR_OPTIONS_EVENTS_DATA', true), // Collect events data, listeners
